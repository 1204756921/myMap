...
export default class DrawPolygon {
    constructor(viewer, drawType,isShow) {
        this.viewer = viewer;
        this.isShow = defaultValue(isShow, false);
    ...
    startDraw(callback, fontColor, fillColor, outLineColor) {
        ...
        this.entity = null;
        this.positions = [];
        this.fontColor = defaultValue(fontColor, Color.LIGHTCYAN);
    ...
    _computeArea(positions) {
        ...
        for (var i = 0; i < positions.length; i++) {
            ...
            arr.push({longitude:p.longitude, latitude:p.latitude,height:p.height});
        }
